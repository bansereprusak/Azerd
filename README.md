...
### INSTALL SCRIPT 
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/bansereprusak/Azerd/ABSTRAK/felsdown.sh && chmod +x felsdown.sh && ./felsdown.sh
</code></pre>

### PERINTAH UPDATE 
<pre><code>wget https://raw.githubusercontent.com/bansereprusak/Azerd/ABSTRAK/files/update.sh && chmod +x update.sh && ./update.sh</code></pre>
