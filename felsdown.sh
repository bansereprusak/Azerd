...
TIMES="10"
CHATID="5843263973"
KEY="6678973298:AAEPVU-dzdBZ_8nSEuh3jt9ICGyaG1HUYE0"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[46m                BAN SEREP RUSAK \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/bansereprusak/Azerd/ABSTRAK/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/bansereprusak/Azerd/ABSTRAK/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/bansereprusak/Azerd/ABSTRAK/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/bansereprusak/Azerd/ABSTRAK/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/bansereprusak/Azerd/ABSTRAK/REGIST | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/bansereprusak/Azerd/ABSTRAK/REGIST | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/bansereprusak"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6287788542840"}]]}'
...
wget raw.githubusercontent.com/bansereprusak/Azerd/ABSTRAK/files/limit.sh && chmod +x limit.sh && ./limit.sh
